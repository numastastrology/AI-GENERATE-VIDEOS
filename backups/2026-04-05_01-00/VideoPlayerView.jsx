...
const LOCAL_SCENE_SETS = {
  ...
  wondersOfWorld: [
    { id: 'ww1', label: 'Scene 1: Great Wall — The Moonlight Waltz', url: '/wonders_scene1.png', angle: 'pan-right', shot: 'Pivot Spin Cinematic', impact: false },
    { id: 'ww2', label: 'Scene 2: Taj Mahal — The Dawn Embrace', url: '/wonders_scene2.png', angle: 'zoom-in', shot: 'Neural Identity Close-Up', impact: false },
    { id: 'ww3', label: 'Scene 3: Machu Picchu — High Altitude Romance', url: '/wonders_scene3.png', angle: 'pull-back', shot: 'Extreme Panoramic Gaze', impact: false },
    { id: 'ww4', label: 'Scene 4: Petra — Torchlit Sandstone Waltz', url: '/wonders_scene4.png', angle: 'close-up', shot: 'Candlelight Focus', impact: false },
    { id: 'ww5', label: 'Scene 5: Colosseum — Roman Night Serenade', url: '/wonders_scene5.png', angle: 'zoom-in', shot: 'Low Angle Interaction', impact: false },
    { id: 'ww6', label: 'Scene 6: Rio — Sunset at Christ the Redeemer', url: '/wonders_scene6.png', angle: 'aerial', shot: 'Aerial Romantic Finale', impact: false },
    { id: 'ww7', label: 'Scene 7: Chichen Itza — Moonlight Dance Sequence', url: '/wonders_scene7.png', angle: 'pan-left', shot: 'Slow-Motion Waltz', impact: false },
    { id: 'ww8', label: 'Scene 8: Great Pyramid — Tender Giza Sunrise', url: '/wonders_scene8.png', angle: 'low-angle', shot: 'Cradle Gaze Sequence', impact: false },
    { id: 'ww9', label: 'Scene 9: Angkor Wat — Sacred Reflection Dance', url: '/wonders_scene9.png', angle: 'zoom-out', shot: 'Final Triumphant Kiss', impact: false },
  ],
};
...
const VideoPlayerView = ({ formData, onBack, onOpenGallery }) => {
  ...
  const wondersFaceConfigs = {
    ww1: { top: '32%', left: '35%', scale: 2.2, rotate: '3deg', filter: 'contrast(1.1) brightness(0.9) saturate(0.8) sepia(0.2)' },
    ww2: { top: '35%', left: '46%', scale: 1.9, rotate: '-2deg', filter: 'contrast(1.1) brightness(1.0) saturate(1.1)' },
    ww3: { top: '28%', left: '42%', scale: 2.0, rotate: '0deg', filter: 'contrast(1.2) brightness(0.9) saturate(0.9)' },
    ww4: { top: '38%', left: '55%', scale: 2.1, rotate: '5deg', filter: 'contrast(1.15) brightness(0.85) sepia(0.3)' },
    ww5: { top: '35%', left: '48%', scale: 2.3, rotate: '-5deg', filter: 'contrast(1.2) brightness(0.8) saturate(0.9)' },
    ww6: { top: '30%', left: '38%', scale: 2.0, rotate: '2deg', filter: 'contrast(1.1) brightness(0.95) saturate(1.1)' },
    ww7: { top: '40', left: '50%', scale: 2.1, rotate: '0deg', filter: 'contrast(1.3) brightness(0.8) saturate(0.8)' },
    ww8: { top: '36%', left: '58%', scale: 2.2, rotate: '-3deg', filter: 'contrast(1.2) brightness(0.95) sepia(0.2)' },
    ww9: { top: '32%', left: '45%', scale: 2.0, rotate: '4deg', filter: 'contrast(1.15) brightness(0.9) saturate(1.1)' },
  };
