...
const GENRE_ACTIONS = {
  ...
  Wonders: [
    "Scene 1: Great Wall of China — Rajagopal spins the Japanese heroine in a pivot dance under the moonlight",
    "Scene 2: Taj Mahal — India — Tender embrace at dawn, Rajagopal and Japanese heroine silhouette against the marble",
    "Scene 3: Machu Picchu — Peru — A majestic waltz on the terraces, mist swirling around the romantic duo",
    "Scene 4: Petra — Jordan — Torchlit gaze, Rajagopal holds heroines hands as they dance near the Treasury",
    "Scene 5: Colosseum — Italy — A playful dip dance, Rajagopal supports the Japanese heroine under golden Roman arches",
    "Scene 6: Christ the Redeemer — Brazil — Sunset finale, Rajagopal and Japanese heroine stand in a cinematic pose",
    "Scene 7: Chichen Itza — Mexico — Firefly waltz, the couple glides gracefully across the ancient stone plaza",
    "Scene 8: Great Pyramid of Giza — Egypt — Sunrise serenade, Rajagopal whispers to the Japanese heroine in the desert",
    "Scene 9: Angkor Wat — Cambodia — Sacred reflection, a slow-motion dance by the lotus pond at dawn",
  ],
};
