...
const LOCAL_SCENE_SETS = {
  ...
  sciFi: [
    ...
    { id: 'sf10', label: 'AFTERMATH — Blinding Light', url: '/predator_scene10.png', angle: 'aerial', shot: 'Charred Jungle Crater', action: 'victory', facePos: null },
  ],
};
...
const VideoPlayerView = ({ formData, onBack, onOpenGallery }) => {
  ...
  const currentFaceConfig = sciFiFaceConfigs[scenes[activeScene]?.id] || null;
        ...
        <div className="player-section">
          ...
          <div className={`cinema-screen glass-panel ${isImpact ? 'impact-shake' : ''}`} style={{ aspectRatio: aspectRatio === '9:16' ? '9/16' : '16/9' }}>
            <div className="screen-wrapper">
              ...
              {/* CINEMATIC HERO INTEGRATION — Only on scenes featuring the human character */}
              {scenes.length > 0 && currentFaceConfig && (
                <div 
